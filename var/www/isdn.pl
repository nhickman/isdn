...
sub getPeer {
    ...
    #Persistent options
		...
		$pDisplay="<div style='margin: 0px 0px 20px 0px;'>Peer configuration #" . $p . "<br></div>".
					...
					"<tr><td class='pLabel'>Dial Number:&nbsp;</td><td colspan=2 class='pValue'><input name='pNumber' type='text' value='".$pNumber."' maxlength=50 style='width: 100px;' /><label class='pDesc'><i>(acceptable digits: 0-9, #, *)<br>backup numbers can be seperated by +.  ex: 1111+2222</i></label></td></tr>".
					"<tr><td colspan=3 style='height: 5px;'>&nbsp;</td></tr>".
