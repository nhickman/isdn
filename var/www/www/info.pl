		...
		<div id='content'>
			...
			<div id='col1'>
				<fieldset>
					...
					<div id='setting'><span id='label'>DHCP Server: </span>$service_udhcpd</div>
					<div id='setting'><span id='label'>Router: </span>$service_zebra</div>
					<div id='setting'><span id='label'>OSPF: </span>$service_ospfd</div>
					<div id='setting'><span id='label'>RIP: </span>$service_ripd</div>
					<div id='setting'><span id='label'>BGP: </span>$service_bgpd</div>
					<div id='setting'><span id='label'>EIGRP: </span>$service_eigrpd</div>
				</fieldset>
			</div>	<br clear='all'>
...
sub getInfo {
	...
	$rtr_model = `cat /.model`;
	$rtr_fsversion = `/usr/bin/dt/msgsend 4106`;
